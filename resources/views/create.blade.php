            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" class="form-control" name="title" placeholder="Article Title"
                            required>
                    </div>
                    <div class="form-group">
                        <label for="excerpt">Excerpt</label>
                        <input type="text" id="excerpt" class="form-control" name="excerpt"
                            placeholder="Article Excerpt" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <img class="card-img-top mt-2" id="imgbox" src="storage/images/no_image.jpg" alt="Current Image"
