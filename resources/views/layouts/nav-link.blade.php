...
<head>
    ...
    <link href="{{ asset('css/article_list.css') }}" rel="stylesheet">
</head>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p>
                    <a href="/news"
                        class="{{ request()->is('news') ? 'btn btn-primary my-2' : 'btn btn-secondary my-2' }}"
                        aria-current="{{ request()->is('news') ? 'page' : 'false' }}">News</a>
                    <a href="/tour"
                        class="{{ request()->is('tour') ? 'btn btn-primary my-2' : 'btn btn-secondary my-2' }}"
                        aria-current="{{ request()->is('tour') ? 'page' : 'false' }}">Tour</a>
                </p>
            </div>
        </section>
        @yield('content')
